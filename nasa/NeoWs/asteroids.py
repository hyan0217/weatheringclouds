...
class Asteroids:
    ...
    def get_asteroids_today(self):
        ...
        for neo in neos[date_key]:
            ...
            close_approach_epoch = datetime.datetime.strptime(
                neo['close_approach_data'][0]['close_approach_date_full'], '%Y-%b-%d %H:%M')
            ...
            asteroid_list.append(
                (name, close_approach_epoch, miss_miles, diameter_miles, url))
